        ...
        <nav className='cont--navbar'>
            <div className="flexbox">
                <div className='name-container'>
                    <svg ref={imageRef} width="30" height="30" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {width > breakpoint ? <><a href='#hero'>Johnny Nguyen</a><span>, Front-end Developer</span></> : <a href='#hero'>Johnny Nguyen</a>}
                ...
                <div>
                    <ul>
                        ...
                        <li><a target="_blank" rel="noreferrer noopener" href={resume}>Resume</a></li>
                    </ul>
                </div>
            </div>
        </nav>
